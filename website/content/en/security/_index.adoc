...
* The -STABLE branch tags have names like `stable/14`. The corresponding builds have names like `FreeBSD 14.4-STABLE`.
* Each FreeBSD Release has an associated Security Branch. The Security Branch tags have names like `releng/14.4`. The corresponding builds have names like `FreeBSD 14.4-RELEASE-p4`.
...
For users that have previously installed a binary version of FreeBSD (e.g., {rel150-current} or {rel144-current}), commands:
...
|releng/15.1 |15.1-RELEASE |June 16, 2026|March 31, 2027
|releng/15.0 |15.0-RELEASE |December 2, 2025 |September 30, 2026
|stable/14 |n/a |n/a |November 30, 2028
|releng/14.4 |14.4-RELEASE |March 10, 2026 |December 31, 2026
|===
