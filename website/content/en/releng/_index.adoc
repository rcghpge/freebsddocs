...
|September 2026 |FreeBSD 14.5 |link:../releases/14.5R/schedule/[Target Schedule]
...
|`main` |Open |committers |Active development branch for 16.0-CURRENT.
|`stable/15` |Open |committers |Development branch for FreeBSD 15-STABLE.
|`releng/15.1` |Frozen |security-officer@FreeBSD.org |FreeBSD 15.1 supported errata fix branch.
|`releng/15.0` |Frozen |security-officer@FreeBSD.org |FreeBSD 15.0 supported errata fix branch.
|`stable/14` |Open |committers |Development branch for FreeBSD 14-STABLE.
|`releng/14.4` |Frozen |security-officer@FreeBSD.org |FreeBSD 14.4 supported errata fix branch.
|`releng/14.3` |Frozen |security-officer@FreeBSD.org |FreeBSD 14.3 errata fix branch (not officially supported).
...
|`stable/13` |Open |committers |Maintenance branch for FreeBSD 13-STABLE (not officially supported).
|`releng/13.5` |Frozen |security-officer@FreeBSD.org |FreeBSD 13.5 errata fix branch (not officially supported).
