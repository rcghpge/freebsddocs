...
Possible arguments: `37`, `38`, `39`

Provide support for easy porting of Electron applications that are distributed in binary form.
Adds a build and run time dependency on package:devel/electron37[],
package:devel/electron38[], or package:devel/electron39[] depending on the argument used.
